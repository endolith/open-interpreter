#!/usr/bin/env python3
"""
Debug script to understand the exact spacing needed by comparing with ground truth.
"""

from rich.console import Console
from rich.markdown import Markdown

def test_ground_truth_spacing():
    """Test the exact spacing by rendering the ground truth block by block."""
    ...
    print("=== GROUND TRUTH BLOCK BY BLOCK ===")
    
    # Test the first few blocks with exact spacing
    for i in range(min(5, len(top_level_tokens))):
        ...
        # Get the block with proper spacing
