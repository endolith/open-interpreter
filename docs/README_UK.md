...
- Найближча альтернатива — це, ймовірно, [gptme](https://github.com/gptme/gptme). Він підтримує не так багато мов для фрагментів коду і лише нещодавно додав часткову підтримку Windows.
...
Існує **експериментальна** підтримка [безпечного режиму](SAFE_MODE.md), щоб зменшити деякі ризики.
