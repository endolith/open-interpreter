...
If you want to make your own profile, start with the [Template Profile](https://github.com/endolith/open-interpreter/blob/main/interpreter/terminal_interface/profiles/defaults/template_profile.py).
...
# Toolbox Settings
toolbox:
  import_toolbox_api: True # Gives OI a helpful Toolbox API designed for code interpreting language models
