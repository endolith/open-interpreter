...
Anonymous [telemetry](telemetry/telemetry) is **disabled by default**. It is optional legacy behavior from the original project and is off unless you enable it.
...
To force telemetry off (the default):
