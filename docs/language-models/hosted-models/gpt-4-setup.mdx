...
1.  **Open Terminal**: You can find it in the Applications folder or search for it using Spotlight (<kbd>Command</kbd> + <kbd>Space</kbd>).
...
4.  **Save and Exit**: Press <kbd>Ctrl</kbd>+<kbd>O</kbd> to write the changes, followed by <kbd>Ctrl</kbd>+<kbd>X</kbd> to close the editor.
