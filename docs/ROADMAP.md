...
- [ ] Terminal/shell execution cluster (filed together, likely shared root causes in `SubprocessLanguage`): hung commands wedging the interpreter (fix in review in [#270](https://github.com/endolith/open-interpreter/pull/270)), missing exit statuses ([#275](https://github.com/endolith/open-interpreter/pull/275)), `prompt_choice` answering without a TTY ([#274](https://github.com/endolith/open-interpreter/pull/274)) plus remaining `-y` gaps [#277](https://github.com/endolith/open-interpreter/issues/277), untruncated-output archive ([#276](https://github.com/endolith/open-interpreter/pull/276)), `get_last_output()` advertised but undefined [#278](https://github.com/endolith/open-interpreter/issues/278), in-band bash signalling [#279](https://github.com/endolith/open-interpreter/issues/279). Separately, the Ollama num_ctx fix is also in review ([#271](https://github.com/endolith/open-interpreter/pull/271))
