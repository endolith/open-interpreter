...
- [ ] Resolve the open Dependabot security alerts (30 on the dependency track, https://github.com/endolith/open-interpreter/security/dependabot) — dependency bumps first, then remove any flagged package that turns out to be unused
