...
The command below, when run in your terminal, will show you which folder they're being saved in (use your arrow keys to move down and press <kbd>Enter</kbd> over `> Open Folder`):
