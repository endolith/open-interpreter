...
- सबसे नज़दीकी विकल्प शायद [gptme](https://github.com/gptme/gptme) है। यह कोड स्निपेट के लिए उतनी भाषाओं का समर्थन नहीं करता और हाल ही में केवल आंशिक Windows समर्थन जोड़ा है।
