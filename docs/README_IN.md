...
आप इसके फ़्लैग (`interpreter --verbose`) का उपयोग करके verbose मोड सक्रिय कर सकते हैं, या चैट के बीच में:

```shell
$ interpreter
...
> %verbose true <- verbose मोड चालू करता है

> %verbose false <- verbose मोड बंद करता है
```
...
- `%verbose [true/false]`: verbose मोड टॉगल करें। बिना तर्क या `true` के साथ verbose मोड में प्रवेश करता है। `false` के साथ verbose मोड से बाहर निकलता है।
