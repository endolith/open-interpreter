...
- La alternativa más cercana es probablemente [gptme](https://github.com/gptme/gptme). No admite tantos lenguajes para fragmentos de código y solo agregó soporte parcial de Windows recientemente.
