...
- Die nächste Alternative ist wahrscheinlich [gptme](https://github.com/gptme/gptme). Es unterstützt nicht so viele Sprachen für Code-Snippets und hat erst kürzlich teilweise Windows-Unterstützung hinzugefügt.
