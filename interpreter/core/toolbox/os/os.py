...
class Os:
    ...
    def get_selected_text(self):
        ...
        current_clipboard = self.toolbox.clipboard.view()
        # Copy the selected text to clipboard
        self.toolbox.clipboard.copy()
        # Get the selected text from clipboard
        selected_text = self.toolbox.clipboard.view()
        # Reset the clipboard to its original content
        self.toolbox.clipboard.copy(current_clipboard)
