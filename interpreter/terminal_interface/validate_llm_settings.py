        ...
        if interpreter.offline:
            ...
            if interpreter.llm.model in [
                ...
                if (
                    ...
                    To use another language model, run `interpreter --local` or consult the documentation at [the language models guide](https://github.com/endolith/open-interpreter/blob/main/docs/language-models/introduction.mdx).
