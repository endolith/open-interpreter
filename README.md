...
- The closest alternative is probably [gptme](https://github.com/gptme/gptme).  It does not support as many languages for code snippets and only added partial Windows support recently.
